...
class PreferencesStore {
  ...
  constructor() {
    ...
    const storedMode = getStoredValue('preferredMode') as 'view' | 'train' | 'bookmarks' | 'positions' | null;
    if (storedMode === 'view' || storedMode === 'train' || storedMode === 'bookmarks' || storedMode === 'positions') {
    ...
    if (storedPlayerColorPref === 'white' || storedPlayerColorPref === 'black' || storedPlayerColorPref === 'random') {
