import type { CreateGameResponse, PublicGameState } from './liveTypes';
...
/** Create a game; returns the game id, the dice commitment, and a join token per seat. */
export async function createGame(white: string, black: string): Promise<CreateGameResponse> {
